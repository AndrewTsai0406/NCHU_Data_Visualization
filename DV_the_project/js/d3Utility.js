...
data = ["file://C:/Users/USER/Desktop/the_project/圖片1.png"]
...
*/
  ...
  globalThis.whosprevious='';
  globalThis.svg1 = d3.select("body")
  .append("svg")
  .attr("width", 1400)
  .attr("height", 580)
  .attr("transform", "translate(" + 500 + "," + -484 + ")")
/*
  svg1.append("rect")
  .attr("width", "100%")
  .attr("height", "100%")
  ...
  */
  ...
  images = svg1.selectAll("image")
  update=images.data(data);
  ...
  console.log(svg1.selectAll('image').data(data).enter())
  console.log(svg1.selectAll('image').data(data).exit())
  console.log(svg1.selectAll('image').data(data))
